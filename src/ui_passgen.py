...
class Ui_PasswordGen(object):
    ...
    def setupUi(self, PasswordGen):
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(PasswordGen)
        ...
        self.password_hide_pushButton = QtWidgets.QPushButton(PasswordGen)
        self.password_hide_pushButton.setObjectName("password_hide_pushButton")
        self.password_layout.addWidget(self.password_hide_pushButton)
        ...
        self.verticalLayout_4.addLayout(self.strength_layout)
        ...
        self.length_horizontalSlider.setMaximum(128)
        ...
        self.verticalLayout_4.addLayout(self.length_layout)
        ...
        self.types_normal_layout = QtWidgets.QHBoxLayout()
        self.types_normal_layout.setObjectName("types_normal_layout")
        ...
        self.types_normal_layout.addWidget(self.types_lower_alphabet_pushButton)
        ...
        self.types_normal_layout.addWidget(self.types_higher_alphabet_pushButton)
        ...
        self.types_normal_layout.addWidget(self.types_numbers_pushButton)
        self.types_full_layout.addLayout(self.types_normal_layout)
        ...
        self.verticalLayout_4.addLayout(self.types_layout)
        self.include_layout = QtWidgets.QHBoxLayout()
        self.include_layout.setObjectName("include_layout")
        self.include_label = QtWidgets.QLabel(PasswordGen)
        self.include_label.setObjectName("include_label")
        self.include_layout.addWidget(self.include_label)
        self.include_lineEdit = QtWidgets.QLineEdit(PasswordGen)
        self.include_lineEdit.setObjectName("include_lineEdit")
        self.include_layout.addWidget(self.include_lineEdit)
        self.include_help_pushButton = QtWidgets.QPushButton(PasswordGen)
        self.include_help_pushButton.setMinimumSize(QtCore.QSize(21, 25))
        self.include_help_pushButton.setMaximumSize(QtCore.QSize(21, 25))
        self.include_help_pushButton.setObjectName("include_help_pushButton")
        self.include_layout.addWidget(self.include_help_pushButton)
        self.verticalLayout_4.addLayout(self.include_layout)
        self.exclude_layout = QtWidgets.QHBoxLayout()
        self.exclude_layout.setObjectName("exclude_layout")
        self.exclude_label = QtWidgets.QLabel(PasswordGen)
        self.exclude_label.setObjectName("exclude_label")
        self.exclude_layout.addWidget(self.exclude_label)
        self.exclude_lineEdit = QtWidgets.QLineEdit(PasswordGen)
        self.exclude_lineEdit.setObjectName("exclude_lineEdit")
        self.exclude_layout.addWidget(self.exclude_lineEdit)
        self.exclude_help_pushButton = QtWidgets.QPushButton(PasswordGen)
        self.exclude_help_pushButton.setMinimumSize(QtCore.QSize(21, 25))
        self.exclude_help_pushButton.setMaximumSize(QtCore.QSize(21, 25))
        self.exclude_help_pushButton.setObjectName("exclude_help_pushButton")
        self.exclude_layout.addWidget(self.exclude_help_pushButton)
        self.verticalLayout_4.addLayout(self.exclude_layout)
    ...
    def retranslateUi(self, PasswordGen):
        ...
        self.password_hide_pushButton.setText(_translate("PasswordGen", "Hide"))
...
"Strength"))
        ...
        self.include_label.setText(_translate("PasswordGen", "Include"))
        self.include_help_pushButton.setText(_translate("PasswordGen", "?"))
        self.exclude_label.setText(_translate("PasswordGen", "Exclude"))
        self.exclude_help_pushButton.setText(_translate("PasswordGen", "?"))
